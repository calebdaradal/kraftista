...
export interface PromoCtaBannerProps {
  title: string;
  description: string;
  ctaHref: string;
  ctaLabel: string;
...
/** Gradient promo band used on the home page and Services footer CTA. */
export function PromoCtaBanner({ title, description, ctaHref, ctaLabel }: PromoCtaBannerProps) {
  return (
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-primary to-secondary p-8 md:p-16">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="space-y-4 text-white flex-1">
              ...
              <p className="text-lg opacity-90 max-w-lg">{description}</p>
            </div>
