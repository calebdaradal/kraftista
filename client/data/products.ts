export interface VariationOption {
  id: string;
  label: string;
  image?: string; // Only for first variation
}
...
export interface Product {
  ...
  material?: string[];
  care?: string[];
  variations?: Variation[]; // Up to 2 variations
}
...
export const products: Product[] = [
    ...
    variations: [
      {
        ...
        name: "Color",
        options: [
          { id: "opt-1", label: "Cream", image: "🟡" },
          { id: "opt-2", label: "Terracotta", image: "🔶" },
          { id: "opt-3", label: "Blue", image: "🔵" },
        ],
      },
    ],
  },
    ...
    variations: [
      {
        ...
        name: "Color",
        options: [
          { id: "opt-1", label: "Indigo", image: "🔵" },
          { id: "opt-2", label: "Rust", image: "🔶" },
          { id: "opt-3", label: "Cream", image: "🟡" },
        ],
      },
    ],
  },
    ...
    variations: [
      {
        ...
        name: "Color",
        options: [
          { id: "opt-1", label: "Natural", image: "🟤" },
          { id: "opt-2", label: "Black", image: "⚫" },
          { id: "opt-3", label: "Tan", image: "🟠" },
        ],
      },
      {
        id: "var-2",
    ...
    variations: [
      {
        ...
        name: "Gemstone",
        options: [
          { id: "opt-1", label: "Amethyst", image: "💜" },
          { id: "opt-2", label: "Rose Quartz", image: "🌸" },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    fullDescription: "This beautiful hand-shaped terracotta pot is perfect for showcasing your favorite plants or succulents. Crafted from natural terracotta clay, each pot is individually shaped and fired. The porous nature of terracotta provides excellent drainage and airflow for healthy plant growth. These pots develop a beautiful weathered patina over time, adding character and charm to any space.",
    price: 44.99,
    image: "🪴",
    category: "Gardening",
    ...
    variations: [
      {
        ...
        name: "Size",
        options: [
          { id: "opt-1", label: "Small (15cm)" },
          { id: "opt-2", label: "Medium (20cm)" },
          { id: "opt-3", label: "Large (25cm)" },
        ],
      },
    ],
  },
  {
    ...
    fullDescription: "This comprehensive bamboo kitchen set includes essential utensils for all your cooking needs. Crafted from sustainable bamboo, these tools are lightweight, durable, and eco-friendly. The natural wood grain and finish make them beautiful enough to display on your counter. Perfect for both traditional and non-stick cookware, these utensils won't scratch your pans.",
    price: 59.99,
    image: "🥢",
    category: "Kitchen",
    ...
    variations: [
      {
        ...
        name: "Quantity",
        options: [
          { id: "opt-1", label: "6-Piece Set" },
          { id: "opt-2", label: "12-Piece Set" },
        ],
      },
    ],
  },
